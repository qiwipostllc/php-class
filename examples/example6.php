...
$html .= '<div class="example">
	<h1>Ссылка на карту (кнопка button)</h1>'.$qp->getMapButton( 'comment2', 'button', 'Показать карту' ).'<br><textarea id="comment2" class="comment"></textarea></div>
	<h2>Код примера</h2>
	<div class="_4cs">
		<ol>
			...
			<li class="li1"><div class="de1">* @param $test &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; bool&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <span class="nu0">1</span> - если тестовый доступ <span class="br0">(</span>в этом случае номер телефона и пароль могут быть пустые<span class="br0">)</span>, <span class="nu0">0</span> - если реальный доступ</div></li>
			<li class="li1"><div class="de1">* @param $folder &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; string &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp; относительный путь к папке с файлами</div></li>
			...
			<li class="li1"><div class="de1">&nbsp;</div></li>
			<li class="li1"><div class="de1">/**</div></li>
			<li class="li1"><div class="de1">* Выдает html-код кнопки для отображения карты</div></li>
			<li class="li1"><div class="de1">* @param $commentFieldId &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; <span class="kw1">string</span> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;ID поля с комментарием</div></li>
			<li class="li1"><div class="de1">* @param $type &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <span class="kw1">string</span> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;тип: button <span class="br0">(</span>кнопка<span class="br0">)</span>, image <span class="br0">(</span>рисунок<span class="br0">)</span>. По-умолчанию - ссылка.</div></li>
			<li class="li1"><div class="de1">* @param $text &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <span class="kw1">string</span> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;Текст кнопки или ссылки. Если тип - image, то в данный параметр необходимо передать адрес, где лежит изображение</div></li>
			<li class="li1"><div class="de1">*/</div></li>
			<li class="li1"><div class="de1">echo $qp-<span class="sy0">&gt;</span>getMapButton<span class="br0">(</span> \'comment2\', \'button\', \'Показать карту\' <span class="br0">)</span>;</div></li>
		</ol>
	</div>
	<div>
		<ul>
