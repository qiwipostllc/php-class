...
$html .= '<div class="example">
	<h1>Ссылка на карту (кнопка image)</h1>'.$qp->getMapButton( 'comment2', 'image', 'map.png' ).'<br><textarea id="comment2" class="comment"></textarea></div>
	<h2>Код примера</h2>
	<div class="_4cs">
		<ol>
			...
			<li class="li1"><div class="de1">*/</div></li>
			<li class="li1"><div class="de1">echo $qp-<span class="sy0">&gt;</span>getMapButton<span class="br0">(</span> \'comment2\', \'image\', \'map.png\' <span class="br0">)</span>;</div></li>
		</ol>
	</div>
	<div>
		<ul>
