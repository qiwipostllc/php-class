...
$html .= '<div class="example">
	<h1>Выпадающий список</h1>'.$qp->getDrop( 'my_select', 'machine1', 'comment1' ).'<br><textarea id="comment1" class="comment"></textarea></div>
	<h2>Код примера</h2>
	<div class="_4cs">
		<ol>
			...
			<li class="li1"><div class="de1">&nbsp;</div></li>
			<li class="li1"><div class="de1">/**</div></li>
			<li class="li1"><div class="de1">* Выдает html-код выпадающего списка с доступными терминалами</div></li>
			...
			<li class="li1"><div class="de1">* @param $sclass &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; <span class="kw1">string</span> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;название класса select-а <span class="br0">(</span>используется в javascript-е qp_select_select и qp_select_select_map<span class="br0">)</span></div></li>
			<li class="li1"><div class="de1">*/</div></li>
			<li class="li1"><div class="de1">echo $qp-<span class="sy0">&gt;</span>getDrop<span class="br0">(</span> \'my_select\', \'machine1\', \'comment1\' <span class="br0">)</span>;</div></li>
		</ol>
	</div>
	<div>
		<ul>
