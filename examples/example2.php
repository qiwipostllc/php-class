...
$html .= '<div class="example">
	<h1>Выпадающий список с картой (кнопка button)</h1>'.$qp->getDropWithMap( 'my_select_map', 'machine2', 'comment2', 'button', 'Показать карту' ).'<br><textarea id="comment2" class="comment"></textarea></div>
	<h2>Код примера</h2>
	<div class="_4cs">
		<ol>
			...
			<li class="li1"><div class="de1">*/</div></li>
			<li class="li1"><div class="de1">echo $qp-<span class="sy0">&gt;</span>getDropWithMap<span class="br0">(</span> \'my_select_map\', \'machine2\', \'comment2\', \'button\', \'Показать карту\' <span class="br0">)</span>;</div></li>
		</ol>
	</div>
	<div>
		<ul>
