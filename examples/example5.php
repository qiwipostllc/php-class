...
$html .= '<div class="example">
	<h1>Раскрытый список в виде таблицы</h1>'.$qp->getTable( 'my_table', 'machine3', 'comment3' ).'<br><textarea id="comment3" class="comment"></textarea></div>
	<h2>Код примера</h2>
	<div class="_4cs">
		<ol>
			...
			<li class="li1"><div class="de1">&nbsp;</div></li>
			<li class="li1"><div class="de1">/**</div></li>
			<li class="li1"><div class="de1">* Выдает html-код списка с информацией о доступных терминалах в виде таблицы</div></li>
			...
			<li class="li1"><div class="de1">*/</div></li>
			<li class="li1"><div class="de1">echo $qp-<span class="sy0">&gt;</span>getTable<span class="br0">(</span> \'my_table\', \'machine3\', \'comment3\' <span class="br0">)</span>;</div></li>
		</ol>
	</div>
	<div>
		<ul>
